  ...
  globalThis._ENTRIES = {};
/**/;self.__PRERENDER_MANIFEST="{\"version\":4,\"routes\":{},\"dynamicRoutes\":{},\"notFoundRoutes\":[],\"preview\":{\"previewModeId\":\"105f842282ccd3426d52d04ea6991b8c\",\"previewModeSigningKey\":\"b1ab091f8ef3a66fe1398f3a53b2732b4bdb5ea689b92995375068e41046badc\",\"previewModeEncryptionKey\":\"b4c0003bbca76cf3f698078cd41f9ee65044179191f31910bb9176c4d4a2c85b\"}}"
/**/;/******/ (() => { // webpackBootstrap
/******/ 	"use strict";
...
var _edge_runtime_cookies = __webpack_require__(8224);
...
var modern_browserslist_target = __webpack_require__(8029);
...
function clearPreviewData(res, options = {}) {
    ...
    const { serialize } = __webpack_require__(7160);
...
var async_local_storage = __webpack_require__(2313);
...
function ensureTestApisIntercepted() {
    if (!testApisIntercepted) {
        ...
        if (process.env.NEXT_PRIVATE_TEST_PROXY === "true") {
            const { interceptTestApis, wrapRequestHandler } = __webpack_require__(3361);
            interceptTestApis();
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@formatjs+intl-localematcher@0.5.8/node_modules/@formatjs/intl-localematcher/lib/abstract/languageMatching.js
var data = {
    supplemental: {
        languageMatching: {
            "written-new": [
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@formatjs+intl-localematcher@0.5.8/node_modules/@formatjs/intl-localematcher/lib/abstract/regions.generated.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@formatjs+intl-localematcher@0.5.8/node_modules/@formatjs/intl-localematcher/lib/abstract/utils.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@formatjs+intl-localematcher@0.5.8/node_modules/@formatjs/intl-localematcher/lib/abstract/BestFitMatcher.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@formatjs+intl-localematcher@0.5.8/node_modules/@formatjs/intl-localematcher/lib/abstract/CanonicalizeUValue.js

function CanonicalizeUValue_CanonicalizeUValue(ukey, uvalue) {
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@formatjs+intl-localematcher@0.5.8/node_modules/@formatjs/intl-localematcher/lib/abstract/InsertUnicodeExtensionAndCanonicalize.js


function InsertUnicodeExtensionAndCanonicalize_InsertUnicodeExtensionAndCanonicalize(locale, attributes, keywords) {
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@formatjs+intl-localematcher@0.5.8/node_modules/@formatjs/intl-localematcher/lib/abstract/LookupMatcher.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@formatjs+intl-localematcher@0.5.8/node_modules/@formatjs/intl-localematcher/lib/abstract/UnicodeExtensionComponents.js

function UnicodeExtensionComponents_UnicodeExtensionComponents(extension) {
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@formatjs+intl-localematcher@0.5.8/node_modules/@formatjs/intl-localematcher/lib/abstract/ResolveLocale.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@formatjs+intl-localematcher@0.5.8/node_modules/@formatjs/intl-localematcher/lib/abstract/LookupSupportedLocales.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@formatjs+intl-localematcher@0.5.8/node_modules/@formatjs/intl-localematcher/lib/index.js
...
var negotiator = __webpack_require__(2122);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/next@14.1.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.ts&page=%2Fmiddleware&rootDir=%2FUsers%2Ftom%2Fcodes%2Fjhltech%2Flanding-page-boilerplate&matchers=W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpPyg%2FOlxcLygoPyFfbmV4dCkoPyEuKlxcLig%2FOmljb3xwbmd8c3ZnfGpwZ3xqcGVnfHhtbHx0eHQpJCkoPyFcXC9hcGkpLiopKSguanNvbik%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii8oKD8hX25leHQpKD8hLipcXC4oPzppY298cG5nfHN2Z3xqcGd8anBlZ3x4bWx8dHh0KSQpKD8hL2FwaSkuKikifV0%3D&preferredRegion=&middlewareConfig=eyJtYXRjaGVycyI6W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpPyg%2FOlxcLygoPyFfbmV4dCkoPyEuKlxcLig%2FOmljb3xwbmd8c3ZnfGpwZ3xqcGVnfHhtbHx0eHQpJCkoPyFcXC9hcGkpLiopKSguanNvbik%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii8oKD8hX25leHQpKD8hLipcXC4oPzppY298cG5nfHN2Z3xqcGd8anBlZ3x4bWx8dHh0KSQpKD8hL2FwaSkuKikifV19!
 ...
 * MIT Licensed
 */ 
var preferredCharsets = __webpack_require__(7226);
var preferredEncodings = __webpack_require__(3487);
var preferredLanguages = __webpack_require__(3733);
var preferredMediaTypes = __webpack_require__(4113);
/**
 * Module exports.
 * @public
...
const _context = __webpack_require__(7258);
const reader = {
    url (req) {
        return req.url;
    },
...
const _context = __webpack_require__(7258);
const _fetch = __webpack_require__(3236);
...
"use strict";
module.exports = JSON.parse('{"Hero":{"title1":"Ship","title2":"Landing Page","title3":"Fast","description":"A free, open-source, and powerful landing page boilerplate, ideal for various projects, enabling you to create a landing page in under an hour."},"SocialProof":{"maker":"makers ship fast"},"Feature":{"title":"Features"},"Pricing":{"title":"Pricing","title2":"Get unlimited access.","description":"The page you are currently viewing is an open-source, free boilerplate.","doYouLike":"Do you like this landing page boilerplate?","follow":"Follow my Twitter."},"WallOfLove":{"title":"Wall of Love","description1":"If you use this landing page template and recommend it on your Twitter,","description2":"please let me know","description3":". I will display your tweet and recommendation here."},"FAQ":{"title":"FAQs","description":"Here are some of the most frequently asked questions."},"CTA":{"title":"Build Your Landing Page Now","description1":"Build","description2":"your landing page,","description3":"show","description4":"your product, and","description5":"start earning","description6":"!"},"CTAButton":{"title":"Get Boilerplate"}}');
...
//# sourceMappingURL=middleware.js.map;
  export default (function () {
    ...
    {"name":"middleware","staticRoutes":[{"page":"/_not-found","regex":"^/_not\\-found(?:/)?$","routeKeys":{},"namedRegex":"^/_not\\-found(?:/)?$"}],"dynamicRoutes":[{"page":"/[[...lang]]","regex":"^(?:/(.+?))?(?:/)?$","routeKeys":{"nxtPlang":"nxtPlang"},"namedRegex":"^(?:/(?<nxtPlang>.+?))?(?:/)?$"}],"nextConfig":{"basePath":""}}
  )